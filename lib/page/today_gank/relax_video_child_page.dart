...
class RelaxVideoPage extends StatefulWidget {
  List<RelaxVideoModel> items;

  RelaxVideoPage({Key key, this.items}) : super(key: key);
...
//得到一个ListView
class _MyListState extends State<RelaxVideoPage> {
  @override
                      ...
                      child: new GestureDetector(
                        ...
                        onTap: () {
                          Navigator.push(context,
                              new MaterialPageRoute(builder: (context) => new WebViewPage(getUrl(index))));
                        },
                      ))),
            )
