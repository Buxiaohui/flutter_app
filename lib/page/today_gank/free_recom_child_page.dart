...
class FreeRecomPage extends StatefulWidget {
  List<FreeRecomModel> items;

  FreeRecomPage({Key key, this.items}) : super(key: key);
...
//得到一个ListView
class _MyListState extends State<FreeRecomPage> {
  @override
